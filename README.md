...
Hybrid network intrusion detection experiments using modular machine learning, deep learning, and anomaly detection pipelines.

Project files live in `ids_deep_learning/`. Run commands from that directory:
